      ...
      <div className="container mx-auto flex items-center justify-between h-16 px-4">
        <div
          ...
          <div className="relative">
            <img src={logo} alt="PixelSafe - Plataforma de contratos e cobrança segura para designers" className="h-[90px] w-auto transition-all group-hover:drop-shadow-[0_0_8px_hsl(163_98%_44%/0.6)]" />
          </div>
        </div>
